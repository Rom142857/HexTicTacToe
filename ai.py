...
# ── Hyperparameters ──────────────────────────────────────────────────
LINE_SCORES = [0, 0, 5, 1200, 3000, 50000, 100000]  # eval score per stone count in a window
_DEF_MULT = [0, 1.0, 1.0, 1.2, 1.8, 2.5, 1.0]      # defensive multiplier: extra weight on blocking 3/4/5-in-a-row
